...
import com.jetbrains.libraryservice.repository.ClienteRepository;
...
public class ClienteService {
  ...
  //Modifica un cliente
  @Transactional
  public Cliente modificaCliente(String id, String nombre, String apellido, String direccion, int edad) {
