...
import com.jetbrains.libraryservice.repository.RevistaRepository;
...
public class RevistaService {
  ...
  @Transactional
  public Revista modificaRevista(String id, String titulo, LocalDate fechaPublicacion,
                                 int longitudImpresion, String editorial, String tipo) {
  ...
  @Transactional
  public void borraRevista(String idNovela) {
  ...
  @Transactional(readOnly = true)
  public Revista findByIdRevista(String s) {
