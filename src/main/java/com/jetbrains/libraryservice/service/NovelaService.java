...
import com.jetbrains.libraryservice.repository.NovelaRepository;
...
public class NovelaService {
  ...
  @Transactional(readOnly = true)
  public Novela findById(String id) {
    return novelaRepository.findById(id).orElse(null);
  }

  @Transactional
  public Novela modificaNovela(String id, String titulo, LocalDate fechaPublicacion, int longitudImpresion,
                               String editorial, String autor, String tema, String subgenero) {
  ...
  @Transactional
  public void borraNovela(String idNovela) {
  ...
  @Transactional(readOnly = true)
  public Novela findByIdNovela(String s) {
